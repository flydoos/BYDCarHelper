...
2. [必选] 自动同步车况：开启“智能上电”或“智能锁车”功能（最少选1种），开启智能XXX任务后程序将会自动同步数据，以及自动续期Cookie，不再需要其他额外操作。PS：如果你把电脑/本程序关闭，那就没办法同步数据了
...
![PC端软件截图](https://cdn.jsdelivr.net/gh/flydoos/BYDCarHelper/Images/PC-2.5.0.png)
